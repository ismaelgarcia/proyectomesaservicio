...
<?php
	...
	$sql="SELECT * FROM usuario";// Sentencia sql para obtener todos los registros de la tabla servicio
...
<?php require "header.php";?> <!--Incluye el menu de avegacion-->
	...
	<h4><i class="far  fa-list-alt" 
		...
		title="Catalálogo de usuarios."></i>
		Catálogo de usuarios.
		<a href="inserta_usuario.php" class="btn btn-outline-secondary my-2 my-sm-0"style="margin-left: 50px;"><i class="fa  fa-plus" title="Agregar un registro."></i></a>
