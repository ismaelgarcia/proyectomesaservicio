<!-----
Página: reporte_telecomunicacion.php
...
<?php
	...
	$sql="SELECT * FROM equipo WHERE id_equipoclase=1";// Sentencia sql para obtener todos los registros de la tabla servicio
...
<?php require "header.php";?> <!--Incluye el menu de avegacion-->
	...
	<h4><i class="far  fa-list-alt" 
		...
		title="Reporte equipo de telecomunicaciones."></i>
		Reporte equipo de telecomunicaciones.
