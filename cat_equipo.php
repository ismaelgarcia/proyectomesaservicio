...
<?php
	...
	$sql="SELECT * FROM equipo";// Sentencia sql para obtener todos los registros de la tabla servicio
...
<?php require "header.php";?> <!--Incluye el menu de avegacion-->
	...
	<h4><i class="far  fa-list-alt" 
		...
		title="Catalálogo de eqyipo."></i>
		Catálogo de equipos.
		<a href="inserta_equipo.php" class="btn btn-outline-secondary my-2 my-sm-0"style="margin-left: 50px;"><i class="fa  fa-plus" title="Agregar un registro."></i></a>
			...
			<?php foreach($resultado as $fila):?><!--Ciclo for para recorrer el arreglo $resultado-->
				<tr>
					...
					<td><!-- Íconos para ejecutar las acciones de actualización y eliminación-->
						<a href="actualiza-equipo.php?id_equipo=<?php echo $fila["id_equipo"];?>"
							style="margin-right: 5px;"><i class="far fa-edit" title="Editar un ticket."></i></a> 
					
						<a href="cat_equipo.php?id_equipo=<?php echo $fila["id_equipo"];?>"
