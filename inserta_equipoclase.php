<!-----
Página: inserta_equipoclase.php
...
<?php
    ...
    if (isset($_POST['submit'])) {//Si existe la variable submit obtenida se ejecuta la 
        ...
        $sql = "INSERT INTO equipo_clase (clase)
            values (:clase)";// Sentencia sql para insertar un registro en la tabla servicio
...
<main role="main" class="container" style="margin-bottom: 75px;">        
	<h4><i class="fa fa-plus" 
        ...
        title="añade una clase de equipo."></i>
        Añadir una clase de equipo.
    </h4>    
    <hr>
    ...
    <div style="width:50%;">
		...
		<form method="POST" class="form-group">
            ...
            <div class="form-group">
                <label for="clase">Clase de equipo:</label>
                <input class="form-control" type="text" name="clase" id="clase" required>
            </div>
            <div class="form-group">
