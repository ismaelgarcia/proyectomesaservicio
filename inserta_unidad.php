...
<?php
    ...
    if (isset($_POST['submit'])) {//Si existe la variable submit obtenida se ejecuta la 
        ...
        $sql = "INSERT INTO unidadadministrativa (nombre, titular)
            values (:nombre, :titular)";// Sentencia sql para insertar un registro en la tabla servicio
...
<main role="main" class="container" style="margin-bottom: 75px;">        
	<h4><i class="fa fa-plus" 
        ...
        Añadir una Unidad Administrativa.
    </h4>    
    <hr>
    ...
    <div style="width:50%;">
		...
		<form method="POST" class="form-group">
            ...
            <div class="form-group">
                <label for="descripcion">Unidad administrativa:</label>
                <input class="form-control" type="text" name="nombre" id="nombre" required>
            </div>

            <div class="form-group">
                <label for="usuario">Titular:</label>
                <input class="form-control" type="text" name="titular" id="titular" required>
            </div>
